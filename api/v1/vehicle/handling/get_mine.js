...
export default class GetMyHandlingProfiles extends Modules.REST.Route 
{
    constructor(main) 
    {
        super(main);
    ...
    async get(request) 
    {
        ...
        return request.accept({
            status: 'success',
            data: await Modules.Vehicles.getHandlingDataBySession(authorization, searchParams.get('handling_hash'))
        });
    }
}
