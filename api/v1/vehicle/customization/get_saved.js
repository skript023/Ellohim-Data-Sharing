...
export default class GetSavedCustomizeProfiles extends Modules.REST.Route 
{
    constructor(main) 
    {
        super(main);
    ...
    async get(request) 
    {
        ...
        return request.accept({
            status: 'success',
            data: await Modules.Vehicles.getSavedCustomizeData(authorization, searchParams.get('handling_hash'))
        });
    }
}
