...
export default class GetMyCustomizeProfiles extends Modules.REST.Route 
{
    constructor(main) 
    {
        super(main);
    ...
    async get(request) 
    {
        ...
        return request.accept({
            status: 'success',
            data: await Modules.Vehicles.getCustomizeDataBySession(authorization, searchParams.get('handling_hash'))
        });
    }
}
