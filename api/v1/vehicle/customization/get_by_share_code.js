...
export default class GetCustomizeDataByShareCode extends Modules.REST.Route 
{
    constructor(main) 
    {
        super(main);
    ...
    async get(request) 
    {
        ...
        return request.accept({
            status: 'success',
            data: await Modules.Vehicles.getCustomizeDataByShareCode(searchParams.get('share_code'))
        });
    }
}
