...
export default class GetTeleportDataByShareCode extends Modules.REST.Route 
{
    constructor(main) 
    {
        super(main);
    ...
    async get(request) 
    {
        ...
        return request.accept({
            status: 'success',
            data: await Modules.Player.getTeleportDataByShareCode(searchParams.get('share_code'))
        });
    }
}
