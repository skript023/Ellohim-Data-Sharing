...
export default class GetMyTeleportProfiles extends Modules.REST.Route 
{
    constructor(main) 
    {
        super(main);
    ...
    async get(request) 
    {
        ...
        return request.accept({
            status: 'success',
            data: await Modules.Player.getTeleportDataBySession(authorization, searchParams.get('handling_hash'))
        });
    }
}
