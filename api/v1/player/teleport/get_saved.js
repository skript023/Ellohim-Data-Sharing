...
export default class GetSavedTeleportProfiles extends Modules.REST.Route 
{
    constructor(main) 
    {
        super(main);
    ...
    async get(request) 
    {
        ...
        return request.accept({
            status: 'success',
            data: await Modules.Player.getSavedTeleportData(authorization, searchParams.get('handling_hash'))
        });
    }
}
